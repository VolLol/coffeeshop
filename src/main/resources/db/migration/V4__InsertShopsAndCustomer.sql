...
values (1, 1, 10.20, 'SALE', now() - INTERVAL '1 DAY'),
       (1, 2, 10, 'SALЕ', now() - INTERVAL '7 DAY'),
       (1, 3, 2.21, 'SALЕ', now() - INTERVAL '10 DAY'),
       (1, 1, 26.45, 'SALE', now() - INTERVAL '14 DAY'),
       (1, 1, 10.20, 'SALE', now() - INTERVAL '16 DAY'),
       (1, 2, 10, 'SALЕ', now() - INTERVAL '18 DAY'),
       (1, 3, 2.21, 'SALЕ', now() - INTERVAL '20 DAY'),
       (1, 1, 10.20, 'SALE', now() - INTERVAL '25 DAY'),
       (1, 2, 10.22, 'SALЕ', now() - INTERVAL '29 DAY'),
       (1, 3, 2.21, 'SALЕ', now() - INTERVAL '32 DAY'),
       (1, 1, 10.20, 'SALE', now() - INTERVAL '35 DAY'),
       (1, 2, 10.99, 'SALЕ', now() - INTERVAL '37 DAY'),
       (1, 3, 2.21, 'SALЕ', now() - INTERVAL '40 DAY'),
